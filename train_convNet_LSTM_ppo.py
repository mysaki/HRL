...
from Nets.Critic_Net import Critic_Preprocess_Net
from Nets.ConvNet_LSTM_Net import Track_Net
from Nets.CNN_net_v2 import CNN_Net
...
def test_ppo(args: argparse.Namespace = get_args()) -> None:
    ...
    log_path = os.path.join(
        args.logdir,
        "track_ConvNet_LSTM_rgb_ppo_{}_{}_{}_{}".format(
            time.month, time.day, time.hour, time.minute, time.second
        ),
    )
    log_mode_path = os.path.join(args.logdir, "track_ppo_image_7_28_22_18")
    ...
    if args.test == False:  # trainer
        ...
        # 保存为Excel文件
        df.to_excel(
            "result_track_{}_{}_{}_{}_{}_{}.xlsx".format(
